                ...
                <li key={f.id} className="flex items-center gap-3 rounded-xl border border-border bg-background px-4 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-foreground">
                      {f.name}
                      {f.isCloseFriend && (
                        <span className="ml-1.5 text-[10px] font-normal text-muted-foreground">친한 친구</span>
                      )}
                    </p>
                  ...
                  <button
                    type="button"
                    className={`rounded-lg border px-2.5 py-1.5 text-[10px] font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pullim-blue-500 ${
                      f.isCloseFriend
